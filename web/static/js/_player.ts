...
export var Player = {
    ...
    join_like_channel: function () {
        this.like_channel = document['socket'].channel("like:"+this.ytid, {})
    ...
    join_comment_channel: function () {
        this.comment_channel = document['socket'].channel("comment:"+this.ytid, {})
    ...
    join_presence_channel: function () {
        this.presence_channel = document['socket'].channel("watch:"+this.ytid, {})
