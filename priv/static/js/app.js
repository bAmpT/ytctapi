...
require.register("web/static/components/MessageList.vue", function(exports, require, module) {
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-03a8da54", __vue__options__)
  } else {
    hotAPI.reload("data-v-03a8da54", __vue__options__)
  }
})()}
});
...
var _MessageList = require('../components/MessageList.vue');
...
var Home = exports.Home = {
  ...
  join: function join() {
    ...
    this.channel.on("home_query", function (payload) {
...
var Player = exports.Player = {
    presence_channel: _phoenix.Channel,
    like_channel: _phoenix.Channel,
    comment_channel: _phoenix.Channel,
...
require.register("web/static/js/profile.js", function(exports, require, module) {
"use strict";
...
var Profile = exports.Profile = {
    ...
    channel: _phoenix.Channel,
    constructor: function constructor(theSocket) {
        var _this = this;

        console.log('Initing: Profile');
        if (theSocket == undefined) {
            this.socket = new _phoenix.Socket("/socket", { params: { guardian_token: document['jwt'] } });
            this.socket.connect();
        } else {
            this.socket = theSocket;
        }
        this.socket.channels.forEach(function (theChannel) {
            if (theChannel.topic == "live-html") {
                _this.channel = theChannel;
                return;
            }
        });
        this.joinChannel();
...
require.register("web/static/js/search.js", function(exports, require, module) {
"use strict";
...
window.addEventListener("load", function (event) {
  ...
  var event = new Event("turbolinks:load");
  document.dispatchEvent(event);
}, false); // NOTE: The contents of this file will only be executed if
...
require.register("web/static/js/watch.js", function(exports, require, module) {
"use strict";
...
var Watch = exports.Watch = {
  ...
  join: function join() {
    ...
    // Now that you are connected, you can join channels with a topic:
    this.apiChannel.join().receive("ok", function (resp) {
      console.log("Live-Api: Joined successfully", resp);
    }).receive("error", function (resp) {
      console.log("Live-Api: Unable to join", resp);
    });

    this.apiChannel.on("addNewWord", function (payload) {
      console.log(payload);
  ...
  addNewWord: function addNewWord(word) {
    console.log(word);
